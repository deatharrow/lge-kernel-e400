...
/* LGE_CHANGE_E : 2012-10-13 sungmin.cho@lge.com hi707 is ratated 180 degree. EVB2 no flip, others xy flip */
	...
	{0xb0, 0x14}, //10},// Analog Gain = (0x021A[3]+1)x(0.5+0x20B0/32)
	{0xb1, 0x14},
	{0xb2, 0xf0},
	{0xb4, 0x14},
	{0xb5, 0x38},
  ...
  {0x46, 0x02},//0x08}, //0x02},
	...
	{0x41, 0x90}, 
	{0x42, 0x00}, //Vblank 2
	{0x43, 0x68}, // STEVE Vblank 104 for 50Hz band stop
	...
	{0x41, 0x90}, 
	{0x42, 0x00}, // Vblank 
	{0x43, 0x04}, // STEVE Vblank 104 for 60Hz band stop
	...
	{0x9e, 0x00}, //EXP Unit																	   
	{0x9f, 0xc8},	
	{0xa0, 0x02}, //EXP Max(100Hz) 7.69 fps 
	{0xa1, 0xf9}, 
	{0xa2, 0xb8}, 
...
static struct msm_camera_i2c_reg_conf hi707_night_mode[][14] = {
	/*NIGHT MODE OFF*/
	{
		{0x03, 0x20},
#ifdef LGE_CAMERA_ANTIBAND_50HZ	
	...
	/*NIGHT MODE ON*/
	{
		...
		{0x88, 0x06}, //EXP Max(120Hz) 3.75 fps 
		{0x89, 0x1a}, 
		{0x8a, 0x80}, 
		...
		{0x03, 0x00}, //PAGE 0
#ifdef LGE_CAMERA_ANTIBAND_50HZ	
		{0x90, 0x1a}, //BLC_TIME_TH_ON
		{0x91, 0x1a}, //BLC_TIME_TH_OFF 
#else
		{0x90, 0x20}, //BLC_TIME_TH_ON
		{0x91, 0x20}, //BLC_TIME_TH_OFF 
#endif
		{0x92, 0xe8}, //BLC_AG_TH_ON
		{0x93, 0xe0}, //BLC_AG_TH_OFF
...
/* LGE_CHANGE_E : 2012-10-13 sungmin.cho@lge.com hi707 is ratated 180 degree. EVB2 no flip, others xy flip */
		...
		//{0x9c, 0x05}, //EXP Limit 1071.43.00 fps 
		//{0x9d, 0x78}, 						
...
/* LGE_CHANGE_E : 2012-10-13 sungmin.cho@lge.com hi707 is ratated 180 degree. EVB2 no flip, others xy flip */
	...
	/*HI707_FPS_24000_30000*/
	{
	  ...
	  {0x03, 0x00}, //Page 0
		...
		{0x83, 0x00}, //EXP Normal 25.00 fps 
		{0x84, 0xea}, 
		{0x85, 0x60}, 
...
#ifdef CONFIG_HI707_ROT_180
	coordinate_x = SENSOR_PREVIEW_WIDTH - ((aec_roi >> 16)&0xFFFF);	
	coordinate_y = SENSOR_PREVIEW_HEIGHT -(aec_roi&0xFFFF);
#else
